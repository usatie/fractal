...
/*   Updated: 2022/09/23 18:25:36 by susami           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_keydown_hook(e->fractal_win->ptr, NULL, NULL);
	mlx_mouse_hook(e->fractal_win->ptr, NULL, NULL);
	mlx_expose_hook(e->fractal_win->ptr, NULL, NULL);
	mlx_closebutton_hook(e->mlx_ptr, NULL, NULL);
	mlx_loop_hook(e->mlx_ptr, NULL, NULL);
	mlx_destroy_image(e->mlx_ptr, e->fractal_img->ptr);
	mlx_destroy_window(e->mlx_ptr, e->fractal_win->ptr);
